...
var _room = instance_position(global.cam_alvo.x, global.cam_alvo.y, obj_rooms)

//Definindo a posição - Velocidade que a câmera acompanha o jogador
...
//Transição suave de rooms

cam_x_min_lerp = lerp(cam_x_min_lerp, global.cam_x_min, .12)
cam_x_max_lerp = lerp(cam_x_max_lerp, global.cam_x_max, .12)
cam_y_min_lerp = lerp(cam_y_min_lerp, global.cam_y_min, .12)
cam_y_max_lerp = lerp(cam_y_max_lerp, global.cam_y_max, .12)
